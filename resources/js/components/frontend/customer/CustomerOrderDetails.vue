            ...
            <div class="row  justify-content-center">
                <div class="col-12">
                    <div class="card my-2">
                        <div class="card-header">
                           <router-link :to="{name:'CustomerOrder'}" class="back_arrow" ><h3 style="display:inline-flex"><i class="fas fa-arrow-left"></i></h3></router-link>    <h3 class="text-center mb-0">My Orders</h3>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="text-center mb-0">Shipping To</h5>
                        </div>
                        <div class="card-body">
