            ...
            <nav class="navbar navbar-expand-lg">
                    ...
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <router-link class="dropdown-item text-dark" to="/stall-page/1" @click.native="getStall(1)">General Pavilion</router-link>
                ...
                <div class="row single-cart_item" v-if="miniCart">
                    <div class="col-lg-12">
                        <div class = "row">
                            <div class="col-md-6">
                                <i class="fas fa-times delete_icontwo"  @click="miniCart=false"></i>
                            </div>
                            <div class="col-md-6 text-right mt-2 mb-2">
                    ...
                    <!-- V-for Start -->
                        <div class="col-lg-12 my-3 product-loop-area"  v-for="(cart, index) in carts" :key="index">
                            <div class="row">
                                <div class="col-md-2">
                                    <img v-for="(image, index) in cart.product.image" :key="index" :src="imgUrl+image.image" :alt="cart.product.product_name" v-show="index==0" class="img-fluid cart_image">
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <i class="fas fa-trash-alt delete_icon" @click="removeCartItem(cart.id)"></i>
                                </div>
                    ...
                    <div class="col-lg-12 mt-2">
                        <div class="cart_list">
                            <ul>
                                ...
                                <li>
                                    <router-link to ="/checkout-page" class="btn btn_color btn-block mt-2">Checkout</router-link>
                                </li>
                            </ul>
                        </div>
                    </div>
...
export default {
    ...
    created(){
        ...
        this.imgUrl=this.imgUrl+'/frontend/assets/product-images/'
        // this.getCartItems()
