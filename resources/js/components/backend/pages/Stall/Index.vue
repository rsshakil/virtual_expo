...
export default {
    ...
    created(){
        ...
        this.cardTitle ="stall"
        this.columnsHead.push('Sn','Stall Name','Brand Name', 'Manufacturer Name', 'Open Time','Close Time','Stall Brochure', 'Description', 'Stall Live Broadcust', 'Stall Announcement ', 'Action')
      
        this.columnsBody.push('stall_name','brand_name', 'manufacturer_name', 'open_time', 'close_time', 'stall_brochure', 'stall_description','stall_live_boardcust','stall_announcement')
        // this.columnsBodyExtra = 
         ...
         this.excelFields = {
                ...
                "Stall Brochure"       : "stall_brochure",
                "Stall Description"       : "stall_description",
                "Stall Live Boardcust"       : "stall_live_boardcust",
                "Stall Announcement"       : "stall_announcement",
        }
